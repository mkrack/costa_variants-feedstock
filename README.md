...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/costa_variants-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/costa_variants-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add costa costa-scalapack
# for installing globally
pixi global install costa costa-scalapack
```
...
It is possible to list all of the versions of `costa` available on your platform:
...
```
pixi search costa --channel conda-forge
```
